-- Close KRPP authenticated-fetch work automatically once protected archives are analyzed.
...
drop trigger if exists pppp_tender_fetch_queue_action_reconcile_v1 on public.pppp_tender_fetch_queue;
create trigger pppp_tender_fetch_queue_action_reconcile_v1
after insert or update of status,attempt_count,last_error on public.pppp_tender_fetch_queue
for each row execute function public.pppp_tender_fetch_queue_action_reconcile_v1();
