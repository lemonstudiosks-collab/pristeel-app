...
var VERSION='20260926-market-home7';
...
var SOURCES={
  ...
  eurometal:'https://eurometal.net/',
  steelradar:'https://www.steelradar.com/en/',
...
.pmh-news{margin-top:8px;border:1px solid #E0E8EA;border-radius:16px;background:#fff;overflow:hidden;box-shadow:0 5px 16px rgba(42,73,84,.03)}.pmh-news-head{display:flex;align-items:center;gap:9px;padding:11px 12px 9px;border-bottom:1px solid #EDF1F2}.pmh-news-head .pmh-card-head-icon{width:31px;height:31px}.pmh-news-copy{min-width:0;flex:1}.pmh-news-copy b{display:block;font-size:12px;color:#1F343C}.pmh-news-copy span{display:block;margin-top:2px;font-size:8.7px;color:#89969B}.pmh-news-list{padding:0 11px 8px}.pmh-news-row{width:100%;min-height:47px;border:0;border-top:1px solid #EEF2F3;background:#fff;display:grid;grid-template-columns:minmax(0,1fr) auto;gap:10px;align-items:center;text-align:left;padding:7px 1px;cursor:pointer}.pmh-news-row:first-child{border-top:0}.pmh-news-row strong{display:block;font-size:10.5px;color:#2B3E46}.pmh-news-row small{display:block;margin-top:2px;font-size:8.3px;line-height:1.3;color:#8A969B}.pmh-news-row i{font-style:normal;color:#2685A0;font-size:10px;font-weight:800;white-space:nowrap}.pmh-news-foot{border-top:1px solid #EDF1F2;padding:8px 12px 10px;color:#8B969A;font-size:8.7px}
...
function markup(){
  ...
  +'<div class="pmh-lower-grid">'
    ...
    +'</div></section>'
  +'</div>'
  +'<section class="pmh-news"><div class="pmh-news-head"><span class="pmh-card-head-icon">'+svg('doc')+'</span><div class="pmh-news-copy"><b>Lajme & analiza</b><span>Burime aktuale të industrisë — pa kopjuar lajme të vjetra në Ballinë.</span></div></div><div class="pmh-news-list">'
    +'<button type="button" class="pmh-news-row" data-pmh-source="news"><span><strong>SteelOrbis — Latest News</strong><small>Çelik, çmime, prodhim dhe tregti ndërkombëtare.</small></span><i>Hap ↗</i></button>'
    +'<button type="button" class="pmh-news-row" data-pmh-source="eurometal"><span><strong>EUROMETAL</strong><small>Tregu europian i çelikut dhe distribucioni.</small></span><i>Hap ↗</i></button>'
    +'<button type="button" class="pmh-news-row" data-pmh-source="steelradar"><span><strong>SteelRadar</strong><small>Steel, scrap, iron ore dhe zhvillime të tregut.</small></span><i>Hap ↗</i></button>'
  +'</div><div class="pmh-news-foot">Klikimi hap gjithmonë burimin origjinal.</div></section>';
}
