...
function install(){wrap('saveInvoiceOut','invoice');wrap('pstSaveAdjustment','adjustment');wrap('sendFollowup','followup');wrap('pstPiMail','outbound');}
...
install();[100,400,1200,2500].forEach(function(ms){setTimeout(install,ms);});document.addEventListener('pst:modules-ready',install,{once:true});
