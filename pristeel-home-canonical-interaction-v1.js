...
function loadOpportunitiesFilterPolish(){
  loadScript('__pstOpportunitiesMindmapV5','script[data-pst-opportunities-filter-polish]','pristeel-opportunities-filter-polish-v1.js?v=20260924-compactdesk1','data-pst-opportunities-filter-polish','Nuk u ngarkua mindmap-i i Mundësive.');
}
