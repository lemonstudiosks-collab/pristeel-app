...
function balanced(){
  try{
    ...
    var s=document.createElement('script');s.src='pristeel-ui-balanced-v1.js?v=20260831-1';s.defer=true;s.setAttribute('data-pst-ui-balanced-v1','1');
...
window.PSTUIStandardV1={apply:apply,version:'20260831-balanced1'};
apply();
})();