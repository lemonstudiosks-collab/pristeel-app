...
function hideSidebar(){
  ...
  if(homeActive()){
   ...
   var homeMain=document.querySelector('#app-shell-root>.main,.app-shell>.main');if(homeMain){['width','max-width','min-width','margin'].forEach(function(p){homeMain.style.removeProperty(p);});}
   return;
  }
