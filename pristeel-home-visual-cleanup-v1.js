...
/* The PPPP mark is itself a span, so it must win over the generic brand-copy span rule. */
#pst-home-launchpad-v1 .pst-launch-brand .pst-launch-mark{width:46px!important;height:46px!important;min-width:46px!important;display:flex!important;align-items:center!important;justify-content:center!important;margin:0!important;color:#fff!important;line-height:1!important;white-space:nowrap!important;font-size:11px!important}
...
/* Keep both the create label and plus icon white even when late global button/span rules load. */
#pst-home-launchpad-v1 #pst-launch-create,#pst-home-launchpad-v1 #pst-launch-create>span{color:#fff!important}
#pst-home-launchpad-v1 #pst-launch-create>svg{color:#fff!important;stroke:#fff!important}
