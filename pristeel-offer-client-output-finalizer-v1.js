 ...
 * - Incomplete installation never renders as 0.00 EUR; incomplete drafts are visibly gated.
 * - A pending installation changes the total label to subtotal and blocks PDF export until completed.
...
window.PSTOfferClientOutputFinalizerV1={patch:patch,install:install,documentLang:documentLang,normalizeClientLanguage:normalizeClientLanguage,ensureSerbianGsp:ensureSerbianGsp,ensureVatNote:ensureVatNote,moveBomOutsideOffer:moveBomOutsideOffer,pendingInstallation:pendingInstallation,patchDraftGate:patchDraftGate,draftMap:draftMap};
})();
