...
var busy={},canonicalAnalyze=null,canonicalOwner=null;
...
function apply(){ensureCanonical();return true;}
if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',apply,{once:true});else setTimeout(apply,0);
window.PSTTenderDossierImportV1={version:'1',apply:apply,pickAndUpload:pickAndUpload,uploadProtected:uploadProtected,finalize:finalize,_test:{edge:edge,fileBase64:fileBase64,announcePartial:announcePartial}};
})();