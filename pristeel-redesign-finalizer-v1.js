...
function operatingExperience(){try{var X=window.PSTOperatingExperienceV1;if(X&&typeof X.apply==='function'){X.apply();return;}if(document.querySelector('script[data-pst-operating-experience]'))return;var s=document.createElement('script');s.src='pristeel-operating-experience-v1.js?v=20260823-1';s.defer=true;s.setAttribute('data-pst-operating-experience','1');s.onload=function(){var x=window.PSTOperatingExperienceV1;if(x&&typeof x.apply==='function')x.apply();};document.head.appendChild(s);}catch(e){console.warn('PRISTEEL finalizer operating experience:',e);}}
function dailyZones(){try{var X=window.PSTDailyZonesCleanupV1;if(X&&typeof X.apply==='function'){X.apply();return;}if(document.querySelector('script[data-pst-daily-zones-cleanup]'))return;var s=document.createElement('script');s.src='pristeel-daily-zones-cleanup-v1.js?v=20260825-1';s.defer=true;s.setAttribute('data-pst-daily-zones-cleanup','1');s.onload=function(){var x=window.PSTDailyZonesCleanupV1;if(x&&typeof x.apply==='function')x.apply();};document.head.appendChild(s);}catch(e){console.warn('PRISTEEL finalizer daily zones:',e);}}
function operatingAssistant(){try{var X=window.PSTOperatingAssistantV2;if(X&&typeof X.apply==='function'){X.apply();return;}if(document.querySelector('script[data-pst-operating-assistant-v2]'))return;var s=document.createElement('script');s.src='pristeel-operating-assistant-v2.js?v=20260823-2';s.defer=true;s.setAttribute('data-pst-operating-assistant-v2','1');s.onload=function(){var x=window.PSTOperatingAssistantV2;if(x&&typeof x.apply==='function')x.apply(true);};document.head.appendChild(s);}catch(e){console.warn('PRISTEEL finalizer operating assistant:',e);}}
