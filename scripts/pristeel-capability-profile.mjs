...
export const PRISTEEL_CAPABILITY_PROFILE_VERSION='2026-08-17.2';
...
const DIRECT_MATERIAL=['llamarine','llamarina','llamara','pllake celiku','pllake metalike','material celiku','material metalik','profile celiku','profile metalike','profile hekuri','shufra celiku','shufer celiku','trar celiku','tuba celiku','gypa celiku','tel celiku','tela celiku','litar celiku','zinxhir celiku','rrjete celiku','steel plate','steel sheet','steel coil','steel beam','steel tube','steel pipe','flat bar','angle steel','celik','celiku','celikut','steel','hekur','hekuri','hekurit'];
...
const DIRECT_STRUCTURE=['konstruksion metalik','konstruksione metalike','konstruksion celiku','strukture celiku','struktura celiku','strukture metalike','struktura metalike','steel structure','steelwork','halle metalike','mbulese metalike','platforme metalike','platforma metalike','shkalle metalike','rrethoje metalike','rrethim metalik','shtylle metalike','shtylla metalike','support steel','steel support','frame steel','ura metalike','skela metalike','metal framework','structural steel'];
const STRUCTURE_CONTEXT=['platforme','platforma','walkway','catwalk','grating','shkalle','shkallë','stairs','handrail','parmak','rrethoje','rrethim','fence','mbulese','mbulesë','canopy','halle','hala','warehouse','depo prefabrikuar','konstruksion prefabrikuar','urë','ura','bridge','footbridge','support','mbajtese','mbajtëse','frame','skelet'];
...
const INDUSTRIAL_CONTEXT=['transportues','conveyor','chute','hopper','bunker','silo','duct','pipe rack','piperack','termocentral','power plant','impiant industrial','pajisje industriale','platforme mirembajtjeje','platformë mirëmbajtjeje','maintenance platform','industrial support','mbajtese industriale','mbajtëse industriale','mekanike industriale','mekanike në impiant','punime mekanike'];
...
function payloadText(payload){
  ...
  return['technical_summary','scope','description','object','notice_summary'].map(k=>typeof payload[k]==='string'?payload[k]:'').filter(Boolean).join(' ');
}
