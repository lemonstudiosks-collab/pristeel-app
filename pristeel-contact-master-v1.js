...
function renderShell(){
 ...
 p.innerHTML='<div class="pcm-page"><header class="pcm-head"><div><span>RELATIONSHIPS</span><h1>Kontaktet</h1><p>Një identitet për Gmail, HubSpot, Bitrix24 dhe projektet e PRISTEEL.</p></div><div class="pcm-head-actions"><button type="button" data-pcm-refresh>Rifresko</button><button type="button" data-pcm-classic>Pamja klasike</button></div></header><div class="pcm-toolbar"><label><span>Kërko</span><input id="pcm-search" placeholder="Emër, kompani, email, rol…"></label><label><span>Roli</span><select id="pcm-kind"><option value="">Të gjithë</option><option value="client">Klientë</option><option value="supplier">Furnitorë</option><option value="partner">Partnerë</option></select></label><label><span>Burimi</span><select id="pcm-source"><option value="">Të gjitha</option><option value="gmail">Gmail</option><option value="hubspot">HubSpot</option><option value="bitrix24">Bitrix24</option></select></label></div><section class="pcm-card"><div class="pcm-card-head"><div><b>Contact Master</b><small id="pcm-count">Duke ngarkuar…</small></div></div><div id="pcm-list"><div class="pcm-empty">Duke ngarkuar kontaktet…</div></div></section></div>';
