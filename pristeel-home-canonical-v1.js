...
function explicitWork(p){var s=operationalState(p);return s==='active_work'||s==='work_in_progress'||s==='action_required';}
function blocksHomeAction(p){return explicitWaiting(p);}
