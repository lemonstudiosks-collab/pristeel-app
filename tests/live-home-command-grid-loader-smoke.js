...
const finalizer = src.indexOf("pristeel-redesign-finalizer-v1.js?v=20260905-finance-failopen1");
...
const nav = src.indexOf("pristeel-primary-nav-resilience-v1.js?v=20260905-finance-present1");
