...
const finalizer = src.indexOf("pristeel-redesign-finalizer-v1.js?v=20260926-representations-nav1");
...
const nav = src.indexOf("pristeel-primary-nav-resilience-v1.js?v=20260926-representations-nav1");
