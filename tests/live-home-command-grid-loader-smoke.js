...
const finalizer = src.indexOf("pristeel-redesign-finalizer-v1.js?v=20260921-opportunities-sourcepages1");
const legacy = src.indexOf("pristeel-project-workflow-legacy-capture-v1.js?v=20260822-flow2");
const tender = src.indexOf("pristeel-tender-priority-actions-v1.js?v=20260923-euaward1");
...
const nav = src.indexOf("pristeel-primary-nav-resilience-v1.js?v=20260924-layout-stability2");
