...
const finalizer = src.indexOf("pristeel-redesign-finalizer-v1.js?v=20260823-homegrid2");
const legacy = src.indexOf("pristeel-project-workflow-legacy-capture-v1.js?v=20260822-flow2");
const tender = src.indexOf("pristeel-tender-priority-actions-v1.js?v=20260823-homegrid2");
const home = src.indexOf("pristeel-home-operating-grid-v1.js?v=20260823-homegrid2");
const classification = src.indexOf("pristeel-project-classification-v1.js?v=20260823-homegrid2");
const nav = src.indexOf("pristeel-primary-nav-resilience-v1.js?v=20260823-homegrid2");

assert.ok(finalizer >= 0, 'Redesign finalizer cache key was not bumped for the Home grid release');
