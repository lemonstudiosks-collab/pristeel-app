...
(async()=>{
  ...
  w.PSTEmail={profiles:async()=>[{p:{id:'p1',name:'STACON D-23',client:'STACON',ref:'D-23/26 / 56,661 kg / EUR 133,155'},refs:['d-23/26 / 56,661 kg / eur 133,155'],names:[],tokens:[],emails:[]}]};
  ...
  assert(bootstrap.includes("pristeel-project-reference-v1.js?v=20260812-2"),'Bootstrap must load canonical reference layer early');
