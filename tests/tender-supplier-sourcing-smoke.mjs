...
assert.match(edge,/startsWith\('round_bar_'\)/);
assert.match(edge,/evidence_complete_review/);
assert.match(edge,/tierFetches>=4/);
assert.doesNotMatch(edge,/contact_ready\)\.length>=3/);
