...
assert(bootstrap.indexOf('pristeel-creative-ui-v1.js?v=20260911-fullredesign1') > bootstrap.indexOf('pristeel-project-execution-guard-v1.js'), 'creative UI must load last');
