...
for(const token of ['Ballina','Mundësitë','Projektet','Partnerët','Financat','Sistemi','PYET PPPP','Pyet platformën për çdo projekt']) must(core.includes(token),`Albanian visible UI token missing: ${token}`);
