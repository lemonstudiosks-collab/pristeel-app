...
assert(finalizer.includes("'pristeel-project-centric-workflow-v1.js?v='+Date.now()"), 'Finalizer must cache-bust and load the current project-centric workflow layer');
