...
(()=>{
 ...
 assert(x.positions[0].description.includes('Furnizimi me material'),'Wrapped base description must retain its first line');
 assert(x.positions[0].description.includes('vizatimeve'),'Wrapped base description must retain its continuation line');
