...
(async()=>{
 ...
 assert.strictEqual(pulse.querySelectorAll('.pst-hcc-pulse').length,3,'Default dashboard must show only three compact signals');
 ...
 assert(w.document.getElementById('pst-home-pulse').textContent.includes('Afate këtë javë'),'Week view signal set is missing');
 dom.window.close();
