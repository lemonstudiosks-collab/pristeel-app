...
const blueBack=window.document.querySelector('[data-pst-opp-back]');
assert.equal(window.getComputedStyle(blueBack).backgroundColor,'rgb(63, 159, 194)','Kthehu must render with the blue primary background');
assert.equal(window.getComputedStyle(blueBack).color,'rgb(255, 255, 255)','Kthehu text must render white');
