...
assert.match(contacts,/await Promise\.allSettled\(jobs\);activate\(\);renderList\(\)/,'Contact Master must reclaim the single visible Partners surface after async loading');
