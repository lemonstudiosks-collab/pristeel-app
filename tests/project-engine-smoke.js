...
var stacon=E.buildDossier({
  ...
  contextFacts:[{id:'fact-1',category:'supplier_pricing',fact_key:'supplier_quote.sector',value:{supplier:'Sector Construction',unit_price_eur_per_m:155}}]
});
...
eq(stacon.evidence.contextFacts.length,1,'context facts must survive canonical dossier assembly');
eq(stacon.evidence.contextFacts[0].fact_key,'supplier_quote.sector','context fact identity must be preserved');
