...
(async()=>{
  ...
  assert(bootstrap.includes("pristeel-project-commercial-prefill-rescue-v1.js?v=20260809-1"),'Live bootstrap must load the project commercial prefill rescue after the builder');
