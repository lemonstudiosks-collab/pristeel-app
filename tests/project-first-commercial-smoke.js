...
(async()=>{
  ...
  assert(bootstrap.includes("pristeel-project-first-commercial-v1.js?v=20260809-2"),'Live bootstrap must cache-bust the fixed commercial comparison module');
  assert(commercial.includes("pristeel-project-commercial-prefill-v1.js?v=20260809-1"),'Commercial workflow must load the project-aware offer prefill');
  ...
  const integrity={
    ...
    supplierOffers:[{id:'o1',supplier:'Sector Construction',price_kg:1.85,total_eur:0,currency:'EUR',created_at:'2026-08-09T08:00:00Z'}],
