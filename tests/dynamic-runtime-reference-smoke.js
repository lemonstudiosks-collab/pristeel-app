...
assert(homeInteraction.includes('pristeel-opportunities-filter-polish-v1.js?v=20260923-layout-stability1'),'Fresh presentation bridge must load the current Opportunity Desk');
