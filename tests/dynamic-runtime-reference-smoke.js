...
assert(homeInteraction.includes('pristeel-opportunities-filter-polish-v1.js?v=20260925-in-place-render2'),'Fresh presentation bridge must load the current in-place Opportunity Desk');
