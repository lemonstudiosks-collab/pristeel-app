...
assert(homeInteraction.includes('pristeel-opportunities-filter-polish-v1.js?v=20260926-contactflow1'),'Fresh presentation bridge must load the current in-place Opportunity Desk');
