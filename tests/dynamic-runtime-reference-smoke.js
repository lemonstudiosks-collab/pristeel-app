...
assert(homeInteraction.includes('pristeel-opportunities-filter-polish-v1.js?v=20260918-canonicalfilter1'),'Fresh presentation bridge must load the current Opportunities mindmap');
