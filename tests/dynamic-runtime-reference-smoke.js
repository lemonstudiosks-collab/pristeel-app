...
assert(homeInteraction.includes('pristeel-opportunities-filter-polish-v1.js?v=20260924-layout-stability4'),'Fresh presentation bridge must load the current Opportunity Desk');
