...
function node(id){return{id,style:{},dataset:{},classList:cls(),attrs:{},children:[],parentNode:null,setAttribute(k,v){this.attrs[k]=String(v)},getAttribute(k){return this.attrs[k]||null},remove(){delete nodes[this.id]},insertBefore(ch){ch.parentNode=this;this.children.unshift(ch);if(ch.id)nodes[ch.id]=ch}};}
