...
const dom=new JSDOM(`<!doctype html><html><head></head><body><div class="app-shell"><aside class="sidebar">NAV</aside><main class="main"><div class="content"><div class="page active" id="page-dashboard" style="display:block">HOME</div><div class="page" id="page-finance" style="display:none">FINANCE</div><div class="page" id="page-workspace-projects" style="display:none"><button data-pmm-back>Kthehu</button></div></div></main></div></body></html>`,{url:'https://example.test/',runScripts:'outside-only'});
const {window}=dom;
