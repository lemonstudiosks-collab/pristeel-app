...
const ungmGlobal=parseUngm(`<h1>Excoll - Translation of ILO Knowledge Products - ILO Africa Skills Hub</h1><h3>ILO</h3><div>Reference: IMP-EXCOLLTRAN</div><div>Beneficiary countries or territories: Nepal</div><footer>See also UN operations in Kosovo</footer>`,ungmSource);assert.equal(ungmGlobal,null);
const ungmOsce=parseUngm(`<h1>Long-Term Contract for Vehicle Body Parts Repair for OSCE Mission in Kosovo - Re-advertised</h1><h3>OSCE</h3><div>Reference: RFQ-KOS-2026-77</div><div>Beneficiary country or territory: Kosovo</div><div>Deadline on: 24-Sep-2026</div>`,ungmSource);assert.equal(ungmOsce.authority,'OSCE');
...
const eeasLinks=eeasKosovoTenderLinks(`<a href="/delegations/kosovo/tender-supply-electrical-equipment_en">Tender</a><a href="/delegations/kosovo/vacancy-engineer_en">Vacancy</a>`);assert.deepEqual(eeasLinks,['https://www.eeas.europa.eu/delegations/kosovo/tender-supply-electrical-equipment_en']);
...
const u2=normalizeRecord({title:'Construction of municipal facility',body:'Kosovo civil works',authority:'UNDP',reference:'UNDP-KOS-999',published_date:'2026-09-01',deadline:'2026-10-01',notice_phase:'opportunity'},ungmSource,'2026-09-01T00:00:00Z');
