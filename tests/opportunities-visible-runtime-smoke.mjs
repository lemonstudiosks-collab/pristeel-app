...
assert(bootstrapSrc.includes('pristeel-redesign-finalizer-v1.js?v=20260925-suppliergate1'),'bootstrap must request the fresh Opportunities finalizer revision');
