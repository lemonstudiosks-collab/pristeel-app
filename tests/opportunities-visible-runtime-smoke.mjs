...
assert(bootstrapSrc.includes('pristeel-redesign-finalizer-v1.js?v=20260921-opportunities-sourcepages1'),'bootstrap must request the fresh Opportunities finalizer revision');
...
assert(api&&api.version==='9','current coalesced-render project-centric runtime did not load');
