...
assert(bootstrap.includes('pristeel-project-first-commercial-v1.js?v=20260925-spread-language1'), 'Current human-gated supplier comparison cache-bust must be live');
assert(bootstrap.includes('pristeel-german-commercial-gate-v1.js?v=20260925-gcg1'), 'German Commercial Gate must be live after the supplier comparison');
