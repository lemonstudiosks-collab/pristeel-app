...
(async()=>{
  ...
  assert(bootstrapSource.includes('pristeel-project-first-actions-v1.js?v=20260815-summary2'),'ProjectFirst actions cache-bust must remain on the audited production bootstrap');
