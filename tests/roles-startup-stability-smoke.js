...
assert(home.includes('PSTHomeCommandCenterV2')&&home.includes('PSTHomeStabilityV2')&&home.includes('PSTRedesignFinalizerV1'),'Stable first paint must reconcile the approved Home owners before reveal');
assert(home.includes("document.documentElement.classList.add('pst-runtime-ready')"),'Home presentation layer must explicitly reveal the stable Home');
...
assert(home.includes('setTimeout(revealStableHome,900)'),'Stable reveal must wait through the first bounded Home stabilization pass');
