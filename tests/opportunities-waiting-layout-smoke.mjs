...
assert.match(desk,/VERSION='20260922-stable-scroll1'/,'Opportunity Desk revision must be active');
...
assert.match(interaction,/pristeel-opportunities-filter-polish-v1\.js\?v=20260922-stable-scroll1/,'runtime must cache-bust the new Opportunity Desk');
