...
assert.match(interaction,/pristeel-opportunities-filter-polish-v1\.js\?v=20260925-stable-rows1/,'runtime must cache-bust the stable contacted-company Opportunity Desk');
