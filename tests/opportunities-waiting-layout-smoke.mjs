...
assert.match(interaction,/pristeel-opportunities-filter-polish-v1\.js\?v=20260926-contactflow1/,'runtime must cache-bust the current contacted-company Opportunity Desk');
