...
assert.match(desk,/VERSION='20260924-contacted-workdesk1'/,'Opportunity Desk revision must be active');
...
assert.match(desk,/pst-opp-side/,'Burimi and other filters must live in the left sidebar');
assert.match(desk,/data-pst-opp-field/,'Fusha must remain filterable');
assert.match(desk,/data-pst-opp-winner/,'Fituesi TED must remain filterable');
