...
(async()=>{
 ...
 assert.strictEqual(w.document.getElementById('pst-project-command-view'),null,'Passive startup must not load a project while Project Workspace is inactive');
