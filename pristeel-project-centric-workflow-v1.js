...
#pst-pcw-lifecycle-tabs{position:relative;display:block;min-height:350px;margin:20px 0 15px;padding:0;border:1px solid #E6EDF0;border-radius:22px;background:radial-gradient(circle at center,transparent 0 77px,#E6F0F3 78px 79px,transparent 80px 142px,#EAF1F3 143px 144px,transparent 145px),linear-gradient(135deg,#FBFDFE,#F7FAFB);overflow:hidden}
...
.pst-pcw-map-center{position:absolute;left:50%;top:47%;transform:translate(-50%,-50%);z-index:1;width:160px;height:112px;border-radius:24px;background:#fff;border:1px solid #B9D8E2;box-shadow:0 14px 35px rgba(43,91,108,.1);display:flex;flex-direction:column;align-items:center;justify-content:center;color:#294C5C}
...
#pst-pcw-lifecycle-tabs .pst-pcw-map-node{position:absolute;z-index:2;width:175px;min-height:65px;border-radius:16px;border:1px solid #D6E6EB;background:rgba(255,255,255,.96);box-shadow:0 5px 17px rgba(48,85,98,.05);display:flex;align-items:center;gap:10px;text-align:left;padding:9px 11px;color:#385762;transition:transform .16s ease,border-color .16s ease,box-shadow .16s ease}
...
#pst-pcw-lifecycle-tabs .pst-pcw-map-new{left:calc(17% - 88px);top:17%}#pst-pcw-lifecycle-tabs .pst-pcw-map-draft{right:calc(17% - 88px);top:17%}#pst-pcw-lifecycle-tabs .pst-pcw-map-waiting{left:calc(17% - 88px);top:58%}#pst-pcw-lifecycle-tabs .pst-pcw-map-replied{right:calc(17% - 88px);top:58%}#pst-pcw-lifecycle-tabs .pst-pcw-map-all{left:calc(50% - 88px);bottom:8px;min-height:48px}
#pst-pcw-opportunity-tabs{padding:3px 0 11px;border-bottom:1px solid #E9EFF1}
@media(max-width:720px){#pst-pcw-lifecycle-tabs{min-height:0;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px;padding:15px;background:#F8FBFC}#pst-pcw-lifecycle-tabs:before{display:none}.pst-pcw-map-center{position:static;transform:none;grid-column:1/-1;width:auto;height:75px;border-radius:16px}.pst-pcw-map-center span{display:none}#pst-pcw-lifecycle-tabs .pst-pcw-map-node{position:static;width:auto;min-height:60px;transform:none!important}#pst-pcw-lifecycle-tabs .pst-pcw-map-all{grid-column:1/-1;min-height:50px}}
