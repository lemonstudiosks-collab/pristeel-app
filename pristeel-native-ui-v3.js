...
function recoveryHomeActive(){
  var home=document.getElementById('page-workspace-home');
  return !!(home&&home.classList.contains('active'));
}
function dismissRecoveryNoticeOnHome(){
  if(!recoveryHomeActive())return false;
  var box=document.getElementById('pst-ui-recovery-clean');if(box)box.remove();
  return true;
}
function showRecovery(count){
  count=Number(count||0);if(!count)return;
  if(recoveryHomeActive()){dismissRecoveryNoticeOnHome();return;}
...
html.pst-native-ui-v4-ready #page-workspace-home #pst-native-home-v4 .pn-work-grid{gap:12px!important;margin-bottom:12px!important}
html.pst-native-ui-v4-ready #page-workspace-home #pst-native-home-v4 .pn-panel>header{padding:12px 13px!important}
html.pst-native-ui-v4-ready #page-workspace-home #pst-native-home-v4 .pn-panel>header span{font-size:10px!important;line-height:1.25!important}
html.pst-native-ui-v4-ready #page-workspace-home #pst-native-home-v4 .pn-panel>header h2{font-size:14px!important;line-height:1.3!important;margin-top:3px!important}
html.pst-native-ui-v4-ready #page-workspace-home #pst-native-home-v4 .pn-panel>header p{font-size:11.5px!important;line-height:1.4!important;margin-top:3px!important}
html.pst-native-ui-v4-ready #page-workspace-home #pst-native-home-v4 .pn-panel>header button{font-size:11px!important}
html.pst-native-ui-v4-ready #page-workspace-home #pst-native-home-v4 .pn-work-row{min-height:58px!important;padding:9px 8px!important;gap:10px!important}
html.pst-native-ui-v4-ready #page-workspace-home #pst-native-home-v4 .pn-work-row .pn-row-project{font-size:10.5px!important;line-height:1.3!important}
html.pst-native-ui-v4-ready #page-workspace-home #pst-native-home-v4 .pn-work-row .pn-row-title{font-size:12px!important;line-height:1.32!important}
html.pst-native-ui-v4-ready #page-workspace-home #pst-native-home-v4 .pn-work-row .pn-row-reason{font-size:10.5px!important;line-height:1.35!important}
html.pst-native-ui-v4-ready #page-workspace-home #pst-native-home-v4 .pn-pulse{min-height:66px!important;margin-bottom:12px!important}
html.pst-native-ui-v4-ready #page-workspace-home #pst-native-home-v4 .pn-pulse-item span{font-size:10.5px!important}
html.pst-native-ui-v4-ready #page-workspace-home #pst-native-home-v4 .pn-pulse-item b{font-size:18px!important}
html.pst-native-ui-v4-ready #page-workspace-home #pst-native-home-v4 .pn-exceptions{margin-top:0!important}
...
function installNativeUiApplyGuard(){
  var X=window.PSTNativeUiV5||window.PSTNativeUiV4||window.PSTNativeUiV3;if(!X||typeof X.apply!=='function')return false;
  if(X.apply.__pstFirstPaintGuard)return true;
  var base=X.apply;
  var guarded=function(){var out=base.apply(this,arguments);lockHomeTypography();normalizeHomeCopy();installStablePresentationCss();return out;};
