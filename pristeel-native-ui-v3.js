...
#pst-ui-recovery-clean{position:fixed;z-index:2147483000;top:16px;left:50%;transform:translateX(-50%);width:min(720px,calc(100vw - 32px));display:flex;align-items:center;justify-content:space-between;gap:20px;padding:14px 16px;background:#fff;border:1px solid #E5E7EB;border-left:3px solid #A7874F;border-radius:12px;box-shadow:0 12px 34px rgba(36,52,71,.12);font-family:Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:#243447}
...
#pst-native-home-v3 #pn-ask .pst-live-command-shell{background:#fff!important;border:1px solid #E5E7EB!important;border-left:3px solid #1E3A8A!important;border-radius:10px!important;box-shadow:none!important;padding:14px 16px!important;color:#243447!important;min-height:0!important}
...
#pst-native-home-v3 #pn-ask .pst-live-command-shell form{margin-top:10px!important;background:#F7F8FA!important;border:1px solid #E5E7EB!important;border-radius:9px!important;padding:7px!important}
