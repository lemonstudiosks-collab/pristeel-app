...
#pst-ui-recovery-clean{position:fixed;z-index:2147483000;top:16px;left:50%;transform:translateX(-50%);width:min(720px,calc(100vw - 32px));display:flex;align-items:center;justify-content:space-between;gap:20px;padding:14px 16px;background:#FCFBF9;border:1px solid #E4DFD7;border-left:3px solid #806E5A;border-radius:12px;box-shadow:0 12px 34px rgba(65,60,54,.07);font-family:Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:#30373B}
#pst-ui-recovery-clean>div:first-child{display:grid;gap:3px}#pst-ui-recovery-clean b{font-size:13px}#pst-ui-recovery-clean span{font-size:11px;color:#6E7579;line-height:1.45}.pst-rec-actions{display:flex;gap:8px;flex-shrink:0}.pst-rec-actions button{min-height:36px;padding:0 13px;border-radius:8px;border:1px solid #DAD4CB;background:#FCFBF9;color:#5F625F;font-weight:700;cursor:pointer}.pst-rec-actions button[data-rec="restore"]{background:#806E5A;border-color:#806E5A;color:#fff}
#pst-native-home-v3 #pn-ask .pst-live-command-shell{background:#FCFBF9!important;border:1px solid #E4DFD7!important;border-left:3px solid #806E5A!important;border-radius:11px!important;box-shadow:0 6px 20px rgba(65,60,54,.035)!important;padding:14px 16px!important;color:#30373B!important;min-height:0!important}
#pst-native-home-v3 #pn-ask .pst-live-command-shell *{text-shadow:none!important}
#pst-native-home-v3 #pn-ask .pst-live-command-shell h1,#pst-native-home-v3 #pn-ask .pst-live-command-shell h2,#pst-native-home-v3 #pn-ask .pst-live-command-shell h3,#pst-native-home-v3 #pn-ask .pst-live-command-shell b,#pst-native-home-v3 #pn-ask .pst-live-command-shell strong{color:#30373B!important}
#pst-native-home-v3 #pn-ask .pst-live-command-shell p,#pst-native-home-v3 #pn-ask .pst-live-command-shell small,#pst-native-home-v3 #pn-ask .pst-live-command-shell span{color:#6E7579!important}
#pst-native-home-v3 #pn-ask .pst-live-command-shell form{margin-top:10px!important;background:#F2F0EB!important;border:1px solid #E4DFD7!important;border-radius:9px!important;padding:7px!important}
#pst-native-home-v3 #pn-ask .pst-live-command-shell input,#pst-native-home-v3 #pn-ask .pst-live-command-shell textarea{background:transparent!important;color:#30373B!important;border:0!important;box-shadow:none!important}
#pst-native-home-v3 #pn-ask .pst-live-command-shell button{background:#806E5A!important;border-color:#806E5A!important;color:#fff!important;border-radius:8px!important;box-shadow:none!important}
...
html.pst-native-ui-ready{--bg:#F7F5F1!important;--bg2:#FCFBF9!important;--bg3:#F2F0EB!important;--text:#30373B!important;--text2:#50575A!important;--text3:#6E7579!important;--border:#E4DFD7!important;--border2:#DAD4CB!important;--bronze:#806E5A!important;--bronze-bg:#EEEAE3!important;--blue:#7F9299!important;--pst-warm-bg:#F7F5F1;--pst-warm-card:#FCFBF9;--pst-warm-soft:#F2F0EB;--pst-warm-line:#E4DFD7;--pst-warm-text:#30373B;--pst-warm-muted:#6E7579;--pst-warm-primary:#806E5A;--pst-warm-primary-hover:#705F4D;--pst-warm-blue:#7F9299;--pst-warm-success:#7E8E7B;--pst-warm-warning:#A88E68;--pst-warm-danger:#A57B75}
...
/* Softer presentation layer: low-saturation chrome, quiet surfaces, readable text. */
html.pst-native-ui-ready,html.pst-native-ui-ready body,html.pst-native-ui-ready .content,html.pst-native-ui-ready .page,html.pst-native-ui-ready [id^="page-workspace-"],html.pst-native-ui-ready #fin-hub,html.pst-native-ui-ready #page-finance,html.pst-native-ui-ready #page-kek-tenders,html.pst-native-ui-ready #page-contacts,html.pst-native-ui-ready #page-document-center,html.pst-native-ui-ready #page-settings{background:#F7F5F1!important;color:#30373B!important}
html.pst-native-ui-ready .card,html.pst-native-ui-ready .pst-card,html.pst-native-ui-ready #pst-native-home-v3 .pn-kpi,html.pst-native-ui-ready #pst-native-home-v3 .pn-card,html.pst-native-ui-ready #pst-native-home-v3 .pn-ask-wait,html.pst-native-ui-ready #page-workspace-projects .pst-pm-controls,html.pst-native-ui-ready #page-workspace-projects .pst-pm-row,html.pst-native-ui-ready #page-workspace-projects .pst-pm-phase,html.pst-native-ui-ready #page-workspace-projects .pst-pm-empty,html.pst-native-ui-ready #page-workspace-projects .pst-pm-loading,html.pst-native-ui-ready #page-workspace-project .pst-pi-tabs,html.pst-native-ui-ready #page-workspace-project .pf2-card,html.pst-native-ui-ready #page-workspace-project .pf2-current,html.pst-native-ui-ready #page-workspace-project .pf2-next,html.pst-native-ui-ready #page-workspace-project .pf2-summary-tile,html.pst-native-ui-ready #page-workspace-project .pf2-attention,html.pst-native-ui-ready #page-workspace-project .pf2-gate,html.pst-native-ui-ready #page-workspace-project .pf2-shortcut,html.pst-native-ui-ready #fin-hub-grid>div[onclick*="finSwitchTab"],html.pst-native-ui-ready #fin-hub-grid>a,html.pst-native-ui-ready [id^="fin-view-"] .card,html.pst-native-ui-ready [id^="fin-view-"] .fin-card,html.pst-native-ui-ready #fin-inv-sum>div,html.pst-native-ui-ready #page-kek-tenders #pst-opportunities-focus,html.pst-native-ui-ready #page-kek-tenders .pst-pwf-card,html.pst-native-ui-ready #page-kek-tenders .pst-ted-card,html.pst-native-ui-ready #page-workspace-contacts .pcm-card,html.pst-native-ui-ready #page-contacts .pcm-card,html.pst-native-ui-ready #page-workspace-apps .card,html.pst-native-ui-ready #page-document-center .card,html.pst-native-ui-ready #page-settings .card{background:#FCFBF9!important;border-color:#E4DFD7!important;box-shadow:0 5px 18px rgba(65,60,54,.025)!important}
html.pst-native-ui-ready #pst-ws-sidebar,html.pst-native-ui-ready .sidebar{background:#FAF9F6!important;border-right-color:#E4DFD7!important}
html.pst-native-ui-ready input,html.pst-native-ui-ready textarea,html.pst-native-ui-ready select{accent-color:#806E5A}
html.pst-native-ui-ready input:focus,html.pst-native-ui-ready textarea:focus,html.pst-native-ui-ready select:focus{border-color:#806E5A!important;box-shadow:0 0 0 3px rgba(128,110,90,.08)!important}
html.pst-native-ui-ready #pst-ws-sidebar .pst-ws-create,html.pst-native-ui-ready #pst-native-home-v3 #pn-ask .pst-live-command-shell button,html.pst-native-ui-ready #page-workspace-projects .pst-pm-btn.primary,html.pst-native-ui-ready #page-workspace-projects .pst-pm-open,html.pst-native-ui-ready #page-workspace-project .pf2-btn.p,html.pst-native-ui-ready #page-kek-tenders button.primary,html.pst-native-ui-ready #page-kek-tenders .btn-primary,html.pst-native-ui-ready #page-kek-tenders button[style*="#185FA5"],html.pst-native-ui-ready #page-kek-tenders button[style*="#3F7F98"]{background:#806E5A!important;border-color:#806E5A!important;color:#fff!important}
html.pst-native-ui-ready #pst-ws-sidebar .pst-ws-create:hover,html.pst-native-ui-ready #pst-native-home-v3 #pn-ask .pst-live-command-shell button:hover{background:#705F4D!important;border-color:#705F4D!important}
html.pst-native-ui-ready #pst-ws-canonical-nav .pst-ws-navbtn:hover{background:#F5F2ED!important;border-color:#E9E4DD!important;color:#30373B!important}
html.pst-native-ui-ready #pst-ws-canonical-nav .pst-ws-navbtn.active,html.pst-native-ui-ready #page-workspace-projects .pst-pm-chip.on,html.pst-native-ui-ready #page-workspace-projects .pst-pm-chip:hover,html.pst-native-ui-ready #page-workspace-project .pst-pi-tab.on,html.pst-native-ui-ready #page-workspace-project .pf2-badge.info,html.pst-native-ui-ready #fin-tabs button.active,html.pst-native-ui-ready #fin-tabs button.on{background:#EEEAE3!important;border-color:#DED8D0!important;color:#74624F!important}
html.pst-native-ui-ready #pst-ws-canonical-nav .pst-ws-navbtn.active:before,html.pst-native-ui-ready #pst-native-home-v3 .pn-kpi:nth-child(-n+2):after,html.pst-native-ui-ready #fin-hub-grid>div[onclick*="finSwitchTab"]>div:first-child{background:#806E5A!important}
html.pst-native-ui-ready #pst-native-home-v3 .pn-kpi:nth-child(-n+2):after{opacity:.48!important}
html.pst-native-ui-ready #pst-native-home-v3 #pn-ask .pst-live-command-shell{background:#FCFBF9!important;border-color:#E4DFD7!important;border-left-color:#806E5A!important;box-shadow:0 6px 20px rgba(65,60,54,.035)!important}html.pst-native-ui-ready #pst-native-home-v3 #pn-ask .pst-live-command-shell form{background:#F2F0EB!important;border-color:#E4DFD7!important}
html.pst-native-ui-ready #pst-native-home-v3 .pn-live{background:#FCFBF9!important;border-color:#E4DFD7!important;color:#6E7579!important}html.pst-native-ui-ready #pst-native-home-v3 .pn-card>header button{color:#74624F!important}
html.pst-native-ui-ready #pst-native-home-v3 .pn-card>header,html.pst-native-ui-ready #pst-native-home-v3 .pn-row,html.pst-native-ui-ready [id^="fin-view-"] table td,html.pst-native-ui-ready #fin-inv-list table td,html.pst-native-ui-ready #page-kek-tenders table td{border-color:#EEEAE4!important}
html.pst-native-ui-ready #pst-native-home-v3 .pn-row:hover{background:#F8F6F2!important}
html.pst-native-ui-ready #pst-native-home-v3 .pn-row>i,html.pst-native-ui-ready #pst-native-home-v3 .pn-legend button:nth-child(3) i,html.pst-native-ui-ready #pst-native-home-v3 .pn-funnel i{background:#7F9299!important}
html.pst-native-ui-ready #pst-native-home-v3 .pn-row.warn>i,html.pst-native-ui-ready #pst-native-home-v3 .pn-legend button:nth-child(2) i{background:#A88E68!important}
html.pst-native-ui-ready #pst-native-home-v3 .pn-row.danger>i{background:#A57B75!important}html.pst-native-ui-ready #pst-native-home-v3 .pn-row.good>i{background:#7E8E7B!important}
html.pst-native-ui-ready #pst-native-home-v3 .pn-legend button:first-child i{background:#806E5A!important}html.pst-native-ui-ready #pst-native-home-v3 .pn-legend button:nth-child(4) i{background:#DFDAD2!important}
html.pst-native-ui-ready #pst-native-home-v3 .pn-donut{background:conic-gradient(#806E5A 0 calc(var(--a)*1%),#A88E68 calc(var(--a)*1%) calc(var(--b)*1%),#7F9299 calc(var(--b)*1%) calc(var(--c)*1%),#DFDAD2 calc(var(--c)*1%) 100%)!important}
html.pst-native-ui-ready #pst-native-home-v3 .pn-donut:after{background:#FCFBF9!important}html.pst-native-ui-ready #pst-native-home-v3 .pn-funnel div{background:#ECE8E1!important}
html.pst-native-ui-ready #page-workspace-projects .pst-pm-btn,html.pst-native-ui-ready #page-workspace-projects .pst-pm-more,html.pst-native-ui-ready #page-workspace-projects .pst-pm-search,html.pst-native-ui-ready #page-workspace-projects .pst-pm-select,html.pst-native-ui-ready #page-workspace-projects .pst-pm-chip,html.pst-native-ui-ready #page-workspace-project .pf2-btn,html.pst-native-ui-ready #pst-pcw-ted-sales-link{background:#FCFBF9!important;border-color:#DAD4CB!important;color:#5F625F!important}
html.pst-native-ui-ready #page-workspace-project .pf2-next{border-left-color:#806E5A!important}html.pst-native-ui-ready #page-workspace-project .pf2-mail p{background:#F2F0EB!important}html.pst-native-ui-ready #page-workspace-projects .pst-pm-toggle button.on{background:#FCFBF9!important;color:#74624F!important}
html.pst-native-ui-ready #page-workspace-projects .pst-pm-toggle,html.pst-native-ui-ready #page-workspace-projects .pst-pm-col,html.pst-native-ui-ready #page-workspace-projects .pst-pm-col-head,html.pst-native-ui-ready [id^="fin-view-"] table th,html.pst-native-ui-ready #fin-inv-list table th,html.pst-native-ui-ready #page-kek-tenders table th,html.pst-native-ui-ready #page-workspace-contacts table th,html.pst-native-ui-ready #page-contacts table th,html.pst-native-ui-ready #page-document-center table th{background:#F2F0EB!important;border-color:#E4DFD7!important;color:#6E7579!important}
html.pst-native-ui-ready .status-success,html.pst-native-ui-ready .badge-success,html.pst-native-ui-ready [class*="status"][class*="green"]{background:#EDF1EB!important;color:#61705E!important;border-color:#DCE4D9!important}
html.pst-native-ui-ready .status-warning,html.pst-native-ui-ready .badge-warning{background:#F4EFE7!important;color:#7D6747!important;border-color:#E6DDD1!important}
html.pst-native-ui-ready .status-danger,html.pst-native-ui-ready .badge-danger{background:#F4ECEA!important;color:#7E625E!important;border-color:#E4D9D6!important}
...
function loadCore(){
  ...
  var s=document.createElement('script');s.src='pristeel-native-ui-v3-core.js?v=20260902-softpalette1';s.defer=true;s.setAttribute('data-pst-native-ui-v3-core','1');
